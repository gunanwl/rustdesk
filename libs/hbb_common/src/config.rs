...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd1.ntpizza.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "uHOuYpcGHCAD5ij+SOZVgFA9V29iuTwV8iShehw17R0=";
...
pub const RENDEZVOUS_PORT: i32 = 26236;
pub const RELAY_PORT: i32 = 26237;
